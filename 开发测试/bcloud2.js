        ...
        init:function (data) {
            ...
            switch (this.platform) {
                case "sdk":
                    ...
                    logTool.log("[Stat K] " + " model init:" + this.systemData.deviceId +"  _2019-02-28 17:48:34.740");
...
//                4 = MEDIA_ERR_SRC_NOT_SUPPORTED - 不支持音频/视
    ...
    samplePlayer.prototype.autoSeek = function () {
       ...
       this.log("autoSeek:" + m.config.start + "--" + m.startPlay + "-" + m.isEndStartSeek);
        ...
        m.seek(200)
        // console.log(this.video.seek(100))
    }
    ...
    samplePlayer.prototype.seek = function (t) {
        console.log(t,this.video);
        console.log(t,this.video.video);
        console.log(t,this.video.video.currentTime);
        console.log(t,this.video.currentTime);
        if(this.video.seek){
            return this.video.seek(t);
        }
        this.log("seek:" + t);
        this.video.video.currentTime = 200;
    }
...
var VideoPlayer = function () {
    ...
    videoPlayer.prototype.play = function () {
        ...
        m.mediaPlayer.startPlay({
            ...
            useHls: m.model.playType == "vod" && canPlayType && (videoSdkTool.getDevice() == "pc" || videoSdkTool.getDevice() == "mac"),//直播，不支持m3u8，且是pc
            useFlv: m.model.playType == "vod" && hasFlvStream && (m.model.livePlayType == "flv") && (videoSdkTool.getDevice() == "pc" || videoSdkTool.getDevice() == "mac"),
            callback: function () {
    ...
    videoPlayer.prototype.skinSateHandler = function (e) {
        ...
        switch (e.args[1]) {
            ...
            case SkinEvent.PAUSE:
                ...
                break;
            case SkinEvent.SEEK:
                console.log(this.mediaPlayer.seek);
        ...
        switch (e.args[1]) {
            case SkinEvent.FULLSCREEN:
                ...
                if (this.model.config.dfull) {
                    if (videoEl && videoEl.webkitEnterFullscreen && videoSdkTool.getBrowser()!="chrome" && videoSdkTool.getBrowser()!="qqwebview" && videoSdkTool.getBrowser()!="safari") {
...
var BlH5Player = function () {
    ...
    h5player.prototype.init = function () {
        ...
        this.version = "H5_Vod_20190228_4.5.20";
    }
    h5player.prototype.setModelByEnv = function () {
    ...
    h5player.prototype.initPlugin = function () {
        SOTool.setPluginStack([
            ...
            , {name: "media.mediaPlay.hls", url: "//{domain}/player/plugin/streamRender.js"}
            , {name: "media.mediaPlay.flv", url: "//{domain}/player/plugin/flvRender.js"}
